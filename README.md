...
- En modo didáctico, distancias y tamaños se comprimen deliberadamente (solo la geometría orbital kepleriana es fiel). En modo real, las distancias entre planetas son proporcionales 1:1 y los tamaños conservan las proporciones reales entre cuerpos con un multiplicador común (25× por defecto, ajustable 1×–300×). Las órbitas de las lunas escalan con ese mismo multiplicador, de modo que cada sistema planeta-lunas conserva su geometría real exacta (la Luna a ~60 radios terrestres); con el multiplicador en 1×, todo el sistema queda en proporción total exacta.
